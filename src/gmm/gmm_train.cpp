...
int main(int argc, const char *argv[])
{
	...
	/// \TODO --> DONE Initialize GMM from data; initially, you should implement random initialization.
	///
	...
	/// \TODO --> DONE Apply EM to estimate GMM parameters (complete the funcion in gmm.cpp)
